...
export function BankAccountTile({ account, onOpenAccount }) {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 flex flex-col justify-between hover:border-blue-200 dark:hover:border-blue-800 transition-all shadow-sm">
      <div className="space-y-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <h3 className="fin-display font-semibold text-slate-900 dark:text-white text-base mt-0.5">
              {account.name}
            </h3>
          </div>
          <span className="text-[10px] font-semibold bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 px-2.5 py-1 rounded-full whitespace-nowrap">
